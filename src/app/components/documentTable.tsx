...
const allDocuments = [
  ...
  { id: '20250531-PROJ-003', name: 'Contract Review', status: 'Declined', button: 'Outgoing', date: '12 Jan 2023, 12:09am', from: 'legal@corp.com', review: 'SM Ademola' },
  { id: '20250531-PROJ-004', name: 'Invoice Payment', status: 'Submitted', button: 'Outgoing', date: '12 Jan 2023, 12:09am', from: 'adam@documan.com', review: 'SM Ademola' },
  ...
  { id: '20250531-PROJ-006', name: 'Invoice Payment', status: 'Not Started', button: 'Outgoing', date: '12 Jan 2023, 12:09am', from: 'adam@documan.com', review: 'SM Ademola' },
  ...
  return (
    <div className="flex-1 p-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold">Welcome back, Register!</h1>
          ...
          <table className="w-full table-auto text-left border-t border-[#EAECF0] text-sm">
            <thead>
              <tr className="bg-gray-50 text-[#475467] text-[12px] font-500">
                ...
                {activeStatus === 'Outgoing' && (
  <th className="p-2 text-[#475467] font-400 text-[14px]">
    Review by
  </th>
)}
                <th className="p-2"></th>
